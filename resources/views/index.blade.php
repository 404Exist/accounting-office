    ...
    <div class="container text-center d-flex h-100 justify-content-center align-items-center flex-column content">
        ...
        <div class="row buttons-container text-uppercase fs-2 z-1">
            <a href="{{ route('full_accountancy') }}" class="col-md-4 btn-container">
                ...
                <div class="p-2 btn-child-2 bg-primary-color">
        ...
        <div class="container text-center w-75">
            ...
            <div class="d-flex justify-content-center aos-init aos-animate" data-aos="fade-up">
                <a href="{{ route('about_us') }}" class="btn-container text-uppercase">
                    <div class="p-3 btn-child-1 bg-secondary-color">{!! getText('more_about_us') !!}</div>
                        ...
                        <div class="bg-image" data-aos="fade-left" style="background-image: url({{ getPageImage(4) }})">
                            ...
                            <div class="z-1 d-flex justify-content-center" data-aos="fade-up">
                                <a href="{{ route('full_accountancy') }}" class="btn-container text-uppercase">
                                    ...
                                    <div class="p-3 btn-child-right-2 bg-primary-color">{!! getText('get_to_know_us_better') !!}</div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="bg-image" data-aos="fade-left" style="background-image: url({{ getPageImage(5) }})">
                            ...
                            <div class="z-1 d-flex justify-content-center" data-aos="fade-up">
                                <a href="{{ route('establishment_of_the_company') }}" class="btn-container text-uppercase">
                                    ...
                                    <div class="p-3 btn-child-2 bg-primary-color">
    ...
    <div class="features container text-center">
        ...
        <div class="row justify-content-center g-5 my-4">
            ...
            <div class="col-md-2 col-6" data-aos="zoom-in">
                ...
                <p>
                    <small class="text-muted">{!! getText('personal') !!}, {!! getText('telephone') !!}, {!! getText('mail') !!}</small>
                </p>
            </div>
            <div class="col-md-2 col-6" data-aos="zoom-in">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 595.3 841.9" style="enable-background:new 0 0 595.3 841.9;" xml:space="preserve">
                    ...
                    <g style="clip-path:url(#SVGID_00000135648640284354622060000007166565449510318744_);">
                        <path fill="#FFFFFF" d="M310.6,492.5h-22.9c-3.7-0.4-7,2.2-7.4,5.9c-0.4,3.7,2.2,7,5.9,7.4c0.5,0.1,1,0.1,1.5,0h22.9 c3.7,0.4,7-2.2,7.4-5.9c0.4-3.7-2.2-7-5.9-7.4C311.6,492.4,311.1,492.4,310.6,492.5L310.6,492.5z"/>
                        <path fill="#FFFFFF" d="M486.5,499.1c0-3.7-3-6.7-6.7-6.7l0,0H457v-166c0-18.3-14.9-33.1-33.2-33.2H171.4 c-18.3,0-33.1,14.9-33.2,33.2v166H115c-3.7,0-6.7,3-6.7,6.7l0,0v13.1c0,18.3,14.9,33.1,33.2,33.2h312.2 c18.3-0.1,33.1-14.9,33.2-33.2L486.5,499.1z M473.6,512.2c0,11-8.9,19.9-19.9,19.9H141.6c-11,0-19.9-8.9-19.9-19.9v-6.7h133.1 c3.7-0.4,6.3-3.7,5.9-7.4c-0.3-3.1-2.8-5.6-5.9-5.9H151.6V326.5c0-11,8.9-19.9,19.9-19.9h252.3c11,0,19.9,8.9,19.9,19.9v166h-99.6 c-3.7,0.4-6.3,3.7-5.9,7.4c0.3,3.1,2.8,5.6,5.9,5.9h129.5V512.2z"/>
                    </g>
                    <path fill="#FFFFFF" d="M430.4,469.3V329.7c0-5.4-4.3-9.8-9.7-9.8c0,0-0.1,0-0.1,0h-246c-5.4,0-9.8,4.4-9.8,9.8c0,0,0,0.1,0,0.1v139.6 c-0.1,5.4,4.2,9.8,9.6,9.9c0.1,0,0.1,0,0.2,0h246c5.4,0.1,9.8-4.2,9.9-9.6c0-0.1,0-0.2,0-0.3H430.4z M417.2,465.9H178.1V333.2h239.1 V465.9z"/>
                    <text transform="matrix(1 0 0 1 236.5234 428.8039)" fill="#FFFFFF" font-size="63.4961px">2</text>
                    <text transform="matrix(1 0 0 1 272.5586 428.8039)" fill="#FFFFFF" font-size="63.4961px">4h</text>
                </svg>
            ...
            <div class="col-md-2 col-6" data-aos="zoom-in">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 595.3 841.9" style="enable-background:new 0 0 595.3 841.9;" xml:space="preserve">
                    ...
                    <path fill="#FFFFFF" d="M242.4,384c-3.6-0.6-7.1,1.7-7.9,5.3c-0.5,3.7-0.7,7.5-0.6,11.3c0.4,3.7,3.7,6.3,7.4,5.9 c3.1-0.3,5.6-2.8,5.9-5.9c-0.1-2.9,0.1-5.8,0.6-8.7C248.3,388.3,246,384.9,242.4,384L242.4,384z"/>
                    <path fill="#FFFFFF" d="M325.4,334.6c-7.1-2.3-14.5-3.5-21.9-3.7c-20.9,0-40.8,9.4-54.1,25.6c-2.3,2.7-2,6.8,0.8,9.1 c0.1,0.1,0.2,0.2,0.3,0.2c1.2,0.9,2.7,1.4,4.3,1.3c2-0.1,3.9-0.9,5.3-2.3c10.5-13.2,26.6-21,43.5-21c6.1,0.1,12.1,1.1,17.9,3 c3.4,0.8,6.8-1,7.9-4.3c1-3.3-0.8-6.8-4.1-7.9c-0.1,0-0.1,0-0.2-0.1L325.4,334.6z"/>
                    <g>
                        <defs>
                        ...
                        <g style="clip-path:url(#SVGID_00000152978601921575588700000004532554419610237592_);">
                            <path fill="#FEFEFE" d="M314.8,431.3c-20.7,0-39.8,10.9-50.3,28.7c-0.8,1.1-0.7,2.6,0.4,3.5c1.1,0.8,2.6,0.7,3.5-0.4 c0.1-0.2,0.3-0.4,0.3-0.6c9.7-16.2,27.2-26.1,46-26.1c18.8,0.1,36.3,10,46,26.1c0.8,1.1,2.4,1.2,3.5,0.4c0.9-0.7,1.2-1.9,0.8-2.9 c-10.6-17.7-29.7-28.6-50.3-28.7H314.8z"/>
                            <path fill="#FFFFFF" d="M381.8,442.3c-26.3-37-77.5-45.7-114.5-19.4c-7.5,5.3-14.1,11.9-19.4,19.4c-1,1-0.9,2.6,0.1,3.6 c1,1,2.6,0.9,3.6-0.1c0.2-0.2,0.3-0.4,0.4-0.6c24.6-34.8,72.8-43,107.6-18.3c7.1,5,13.3,11.2,18.3,18.3c0.5,0.6,1.2,1,2,1 c0.5,0,1.1-0.2,1.5-0.5C382.4,444.9,382.6,443.4,381.8,442.3C381.8,442.2,381.8,442.2,381.8,442.3L381.8,442.3z"/>
                        </g>
                    </g>
                    <path fill="#FFFFFF" d="M314.8,455c-14.6,0.1-27.6,9.1-32.8,22.8c-0.5,1.3,0.1,2.7,1.4,3.2c0,0,0.1,0,0.1,0.1c0.3,0.1,0.6,0.1,0.9,0 c1,0,2-0.6,2.4-1.6c5.7-15.5,22.8-23.4,38.3-17.7c8.2,3,14.7,9.5,17.7,17.7c0.6,1.3,2,1.9,3.3,1.3c1.2-0.5,1.8-1.8,1.4-3.1 C342.4,464.1,329.4,455,314.8,455L314.8,455z"/>
                    <path fill="#FFFFFF" d="M314.5,476.1c-8.2,0-14.9,6.7-14.9,14.9c0,8.2,6.7,14.9,14.9,14.9c8.2,0,14.9-6.7,14.9-14.9 C329.4,482.8,322.8,476.2,314.5,476.1z M314.5,501c-5.5,0-9.9-4.4-9.9-9.9s4.4-9.9,9.9-9.9s9.9,4.4,9.9,9.9 C324.4,496.6,320,501,314.5,501z"/>
                </svg>
        ...
        <div class="row justify-content-center g-5 mb-4">
            ...
            <div class="col-md-2 col-6" data-aos="zoom-in">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 595.3 841.9" style="enable-background:new 0 0 595.3 841.9;" xml:space="preserve">
                    <circle fill="#D99C5C" cx="297.6" cy="420.9" r="297.6"/>
                    <path fill="#FFFFFF" d="M382.9,274.8H212.4c-16.8,0.1-30.3,13.6-30.4,30.4v231.4c0.1,16.8,13.6,30.3,30.4,30.4h93.5 c8.1,0.1,15.9-3,21.6-8.8l77-77c5.6-5.8,8.8-13.5,8.8-21.6V305.3C413.2,288.6,399.6,275,382.9,274.8L382.9,274.8z M396,472.5l-77,77 c-0.9,1-1.9,1.8-3,2.5v-64.1c0-10.1,8.2-18.2,18.3-18.3h64.2c-0.7,1.1-1.5,2.2-2.5,3L396,472.5z M401.1,457.3h-67 c-16.8,0.1-30.3,13.6-30.4,30.4v67h-91.4c-10.1,0-18.2-8.2-18.3-18.3V305.3c0-10.1,8.2-18.2,18.3-18.3h170.5 c10.1,0,18.2,8.2,18.3,18.3V457.3z"/>
                    <path fill="#FFFFFF" d="M233.7,347.9h106.5c3.4,0.4,6.4-2,6.8-5.4c0.4-3.4-2-6.4-5.4-6.8c-0.5-0.1-0.9-0.1-1.4,0H233.7 c-3.4,0.4-5.8,3.4-5.4,6.8C228.7,345.4,230.9,347.6,233.7,347.9z"/>
                    <path fill="#FFFFFF" d="M233.7,384.4h42.6c3.4,0.4,6.4-2,6.8-5.4s-2-6.4-5.4-6.8c-0.5-0.1-0.9-0.1-1.4,0h-42.6 c-3.4,0.4-5.8,3.4-5.4,6.8C228.7,381.9,230.9,384.1,233.7,384.4z"/>
                    <path fill="#FFFFFF" d="M303.7,372.2c-3.4,0.4-5.8,3.4-5.4,6.8c0.3,2.8,2.6,5.1,5.4,5.4h9.1c3.4-0.4,5.8-3.4,5.4-6.8 c-0.3-2.8-2.6-5.1-5.4-5.4L303.7,372.2z"/>
                    <path fill="#FFFFFF" d="M258.1,445.3h-24.4c-3.4,0.4-5.8,3.4-5.4,6.8c0.3,2.8,2.6,5.1,5.4,5.4h24.4c3.4-0.4,5.8-3.4,5.4-6.8 C263.2,447.9,260.9,445.6,258.1,445.3z"/>
                    <path fill="#FFFFFF" d="M349.2,409H233.7c-3.4,0.4-5.8,3.4-5.4,6.8c0.3,2.8,2.6,5.1,5.4,5.4h115.5c3.4-0.4,5.8-3.4,5.4-6.8 C354.3,411.6,352.1,409.4,349.2,409z"/>
                </svg>
