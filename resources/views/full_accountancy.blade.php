@extends('layout.app', ['title' => getText('full_accountancy')])
    ...
    <section>
        <div class="accounting-office container-fluid">
            <div class="description text-center container">
                <h1 class="display-2 mb-4" data-aos="fade-down">{!! getText('full_accountancy') !!}</h1>
                <hr class="opacity-100 my-4 mx-auto w-25" />

                <div class="mt-5" data-aos="zoom-in">{!! getText('full_accountancy_page_text_1') !!}</div>
            </div>
            <div class="row bg-dark-white">
                ...
                <div class="col-md-6 mt-5 p-5" data-aos="zoom-in">
                    {!! getText('full_accountancy_page_text_2') !!}
                </div>
                <div class="col-md-6 mt-5 p-5" data-aos="zoom-in">
                    {!! getText('full_accountancy_page_text_3') !!}
                </div>
