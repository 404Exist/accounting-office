<div
    ...
    <div class="flex-none w-56 flex flex-row items-center">
        <img src="{{ asset('images/testvine-logo-green.png') }}" class="w-16 flex-none">
            ...
            <div class="dropdown relative md:static">
                ...
                <button class="menu-btn focus:outline-none focus:shadow-outline flex flex-wrap items-center">
                    <div class="w-8 h-8 overflow-hidden rounded-full">
                        <img class="w-full h-full object-cover" src="{{ admin()->picture }}">
                    </div>

                    <div class="ml-2 capitalize flex ">
                        <h1 class="text-sm text-gray-800 font-semibold m-0 p-0 leading-none">{{ admin()->name }}</h1>
                ...
                <div
                    ...
                    <form action="{{ route('admin.logout') }}" method="post">
                        @csrf
                        <button type="submit" class="w-100 text-left px-4 py-2 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 hover:text-gray-900 transition-all duration-300 ease-in-out">
