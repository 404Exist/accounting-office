            ...
            <div class="card-body h-full flex flex-col justify-between">
                ...
                <div class="flex flex-row mt-10 items-end">
                    ...
                    <div class="flex-1 ml-10 w-32 h-32 lg:w-auto lg:h-auto overflow-hidden">
                        <img class="object-cover" src="{{ asset('assets/admin/img/congrats.svg') }}">
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr class="">
                            <td class="py-4 text-sm text-gray-600 flex flex-row items-center text-left">
                                <div class="w-8 h-8 overflow-hidden mr-3">
                                    <img src="{{ asset('assets/admin/img/sneakers.svg') }}" class="object-cover">
                                </div>
                                Sneakers and Tennis
                            </td>
                        ...
                        <tr class="">
                            <td class="py-4 text-sm text-gray-600 flex flex-row items-center">
                                <div class="w-8 h-8 overflow-hidden mr-3">
                                    <img src="{{ asset('assets/admin/img/socks.svg') }}" class="object-cover">
                                </div>
                        ...
                        <tr class="">
                            <td class="py-4 text-sm text-gray-600 flex flex-row items-center">
                                <div class="w-8 h-8 overflow-hidden mr-3">
                                    <img src="{{ asset('assets/admin/img/soccer.svg') }}" class="object-cover">
                                </div>
                                Adidas Soccer Ball
                            </td>
                            <td class="py-4 text-xs text-gray-600">$ <span class="num-2"></span></td>
                        ...
                        <tr class="">
                            <td class="py-4 text-sm text-gray-600 flex flex-row items-center">
                                <div class="w-8 h-8 overflow-hidden mr-3">
                                    <img src="{{ asset('assets/admin/img/food.svg') }}" class="object-cover">
                                </div>
                ...
                <table class="table-fixed w-full">
                    ...
                    <tbody class="text-left text-gray-600">
                        ...
                        <tr>
                            ...
                            <th class="w-1/2 mb-4 text-xs font-extrabold tracking-wider flex flex-row items-center w-full">
                                <div class="w-8 h-8 overflow-hidden rounded-full">
                                    <img src="{{ asset('assets/admin/img/user2.jpg') }}" class="object-cover">
                                </div>
                        ...
                        <tr>
                            ...
                            <th class="w-1/2 mb-4 text-xs font-extrabold tracking-wider flex flex-row items-center w-full">
                                <div class="w-8 h-8 overflow-hidden rounded-full">
                                    <img src="{{ asset('assets/admin/img/user3.jpg') }}" class="object-cover">
                                </div>
                                <p class="ml-3 name-1">user name</p>
                            </th>
                            {{-- name --}}
                        ...
                        <tr>
                            ...
                            <th class="w-1/2 mb-4 text-xs font-extrabold tracking-wider flex flex-row items-center w-full">
                                <div class="w-8 h-8 overflow-hidden rounded-full">
                                    <img src="{{ asset('assets/admin/img/user1.jpg') }}" class="object-cover">
                                </div>
                                <p class="ml-3 name-1">user name</p>
                            </th>
                            {{-- name --}}
