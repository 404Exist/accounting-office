...
@section('content')
    <form action="{{ route('admin.settings.update') }}" method="POST" class="mb-10">
        ...
        <div class="mb-6">
            ...
            <select
                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                id="default_locale" name="default_locale">
                <option value="pl" @selected(getKeySetting('default_locale') == 'pl')>Pl</option>
                <option value="en" @selected(getKeySetting('default_locale') == 'en')>En</option>
            </select>
        </div>
        {{-- MAIL HOST --}}
        <div class="mb-6">
            ...
            <input
                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                type="text" id="MAIL_HOST" name="MAIL_HOST" placeholder="MAIL HOST"
                value="{{ getKeySetting('MAIL_HOST') }}" />
        </div>
        {{-- MAIL PORT --}}
        <div class="mb-6">
            ...
            <input
                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                type="number" id="MAIL_PORT" name="MAIL_PORT" placeholder="MAIL PORT"
                value="{{ getKeySetting('MAIL_PORT') }}" />
        </div>
        {{-- MAIL ENCRYPTION --}}
        <div class="mb-6">
            ...
            <input
                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                type="text" id="MAIL_ENCRYPTION" name="MAIL_ENCRYPTION" placeholder="MAIL ENCRYPTION"
                value="{{ getKeySetting('MAIL_ENCRYPTION') }}" />
        </div>
        {{-- MAIL USERNAME --}}
        <div class="mb-6">
            ...
            <input
                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                type="text" id="MAIL_USERNAME" name="MAIL_USERNAME" placeholder="MAIL USERNAME"
                value="{{ getKeySetting('MAIL_USERNAME') }}" />
        </div>
        {{-- MAIL PASSWORD --}}
        <div class="mb-6">
            ...
            <input
                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                type="text" id="MAIL_PASSWORD" name="MAIL_PASSWORD" placeholder="MAIL PASSWORD"
                value="{{ getKeySetting('MAIL_PASSWORD') }}" />
        </div>
        {{-- MAIL ADDRESS --}}
        <div class="mb-6">
            ...
            <input
                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                type="text" id="MAIL_FROM_ADDRESS" name="MAIL_FROM_ADDRESS" placeholder="MAIL ADDRESS"
                value="{{ getKeySetting('MAIL_FROM_ADDRESS') }}" />
        </div>
        {{-- Site Colors --}}
        <div class="mb-6 flex justify-between px-6">
            <div class="mx-5" style="flex-grow: 1">
                ...
                <input class="form-control h-10" type="color" id="primary_color" name="primary_color"
                    value="{{ getKeySetting('primary_color') }}" />
            </div>
            <div class="mx-5" style="flex-grow: 1">
                <label class="d-block mb-2" for="secondary_color">Site Secondary Color</label>
                <input class="form-control h-10" type="color" id="secondary_color" name="secondary_color"
                    value="{{ getKeySetting('secondary_color') }}" />
            </div>
        </div>
        {{-- facebook --}}
        <div class="mb-6">
            ...
            <input
                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                type="text" id="facebook" name="facebook" placeholder="Facebook"
                value="{{ getKeySetting('facebook') }}" />
        </div>
        {{-- google --}}
        <div class="mb-6">
            ...
            <input
                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                type="text" id="google" name="google" placeholder="Google"
                value="{{ getKeySetting('google') }}" />
        </div>
        {{-- trojmiasto --}}
        <div class="mb-6">
            ...
            <input
                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                type="text" id="trojmiasto" name="trojmiasto" placeholder="Trojmiasto"
                value="{{ getKeySetting('trojmiasto') }}" />
        </div>
        {{-- tel --}}
        <div class="mb-6">
            ...
            <input
                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                type="text" id="tel" name="tel" placeholder="Tel" value="{{ getKeySetting('tel') }}" />
        </div>
        {{-- mail --}}
        <div class="mb-6">
            ...
            <input
                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                type="text" id="mail" name="mail" placeholder="Mail" value="{{ getKeySetting('mail') }}" />
        </div>
        {{-- address --}}
        <div class="mb-6">
        ...
        <div class="mb-6">
            ...
            <input
                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                type="text" id="customer_service" name="customer_service" placeholder="Customer Service"
                value="{{ getKeySetting('customer_service') }}" />
        </div>
        ...
        <div class="mb-6">
            ...
            <input
                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                type="text" id="google_map_embed_link" name="google_map_embed_link"
                placeholder="Google Map Embed Link" value="{{ getKeySetting('google_map_embed_link') }}" />
        </div>
